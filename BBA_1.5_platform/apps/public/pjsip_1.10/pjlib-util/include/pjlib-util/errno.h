 ...
 * Invalid action
 */
 #define PJLIB_UTIL_EFIREWALLINACTION	(PJLIB_UTIL_ERRNO_START+200)/*320200*/

/**
 * @hideinitializer
 * Invalid transport protocol
 */
 #define PJLIB_UTIL_EFIREWALLINPROTO	(PJLIB_UTIL_ERRNO_START+201)/*320201*/

 /**
 * @hideinitializer
 * Invalid destination IP
 */
#define PJLIB_UTIL_EFIREWALLINDSTIP	(PJLIB_UTIL_ERRNO_START+202)/*320202*/

/**
 * @hideinitializer
 * Invalid destination netmask
 */
#define PJLIB_UTIL_EFIREWALLINDSTNM	(PJLIB_UTIL_ERRNO_START+203)/*320203*/

/**
 * @hideinitializer
 * Invalid destination port
 */
#define PJLIB_UTIL_EFIREWALLINDPORT	(PJLIB_UTIL_ERRNO_START+204)/*320204*/

/**
 * @hideinitializer
 * Invalid source IP
 */
#define PJLIB_UTIL_EFIREWALLINSRCIP	(PJLIB_UTIL_ERRNO_START+205)/*320205*/

/**
 * @hideinitializer
 * Invalid source netmask
 */
#define PJLIB_UTIL_EFIREWALLINSRCNM	(PJLIB_UTIL_ERRNO_START+206)/*320206*/

/**
 * @hideinitializer
 * Invalid source port
 */
#define PJLIB_UTIL_EFIREWALLINSPORT	(PJLIB_UTIL_ERRNO_START+207)/*320207*/

/**
 * @hideinitializer
 * Fail to excute Iptables command
 */
#define PJLIB_UTIL_EFIREWALLINIPTABLES	(PJLIB_UTIL_ERRNO_START+208)/*320208*/

/**
 * @hideinitializer
 * Command buffer too small
 */
#define PJLIB_UTIL_EFIREWALLINBUFSMALL	(PJLIB_UTIL_ERRNO_START+209)/*320209*/
