...
} err_str[] = 
{
	...
	/*ycw-firewall*/
	 /*FIREWALL CONFIG*/
	 PJ_BUILD_ERR(	PJLIB_UTIL_EFIREWALLINACTION, "Invalid action"),
	 PJ_BUILD_ERR(	PJLIB_UTIL_EFIREWALLINPROTO, "Invalid network protocol"),
	 PJ_BUILD_ERR(	PJLIB_UTIL_EFIREWALLINDSTIP, "Invalid destination Ip"),
	 PJ_BUILD_ERR(	PJLIB_UTIL_EFIREWALLINDSTNM, "Invalid destination netmask"),
	 PJ_BUILD_ERR(	PJLIB_UTIL_EFIREWALLINDPORT, "Invalid destination port"),
	 PJ_BUILD_ERR(	PJLIB_UTIL_EFIREWALLINSRCIP, "Invalid source Ip"),
	 PJ_BUILD_ERR(	PJLIB_UTIL_EFIREWALLINSRCNM, "Invalid source netmask"),
	 PJ_BUILD_ERR(	PJLIB_UTIL_EFIREWALLINSPORT, "Invalid source port"),
	 PJ_BUILD_ERR(	PJLIB_UTIL_EFIREWALLINIPTABLES, "fail to excute Iptables Command"),
	 PJ_BUILD_ERR( PJLIB_UTIL_EFIREWALLINBUFSMALL, "Command buffer too small"),
};
