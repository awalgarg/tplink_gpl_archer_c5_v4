...
/* add by yuanjp 2015/8/12 */
#if INCLUDE_FWMARK
static int l_sockOptFwmark = 0;

int pj_setSockFwmark(int fwmark)
{
	l_sockOptFwmark = fwmark;
}
#endif
/* add by yuanjp end */
				   ...
				   pj_sock_t *sock)
{
    ...
    *sock = socket(af, type, proto);
	...
	if (l_sockOptFwmark)
	{
		pj_sock_setsockopt(*sock, pj_SOL_SOCKET(), SO_MARK, 
			(void *)&l_sockOptFwmark, sizeof(l_sockOptFwmark));
	}
#endif
	return PJ_SUCCESS;
    }
