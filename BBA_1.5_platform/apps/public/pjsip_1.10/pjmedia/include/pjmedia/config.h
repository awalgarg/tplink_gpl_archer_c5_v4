...
#   define PJMEDIA_HAS_SRTP			    0 /*ycw-pjsip--there is something wrong about srtp, so disable it.And, If I have time, I will fix this bug*/
#endif
...
#   define PJMEDIA_HANDLE_G722_MPEG_BUG		    0/*1*//*ycw-pjsip*/
#endif
...
/**
 * Specify the platform which we developed on.
 * Now, we define these Micro manually. If you have time, modify it to define automatical * ly.
 */
#ifndef PJMEDIA_FOR_PLATFORM_TC
#	define PJMEDIA_FOR_PLATFORM_TC		1
#endif

#ifndef PJMEDIA_FOR_PLATFORM_ATHEROS
#	define PJMEDIA_FOR_PLATFORM_ATHEROS	0
#endif

#ifndef PJMEDIA_FOR_PLATFORM_PMC
#	define PJMEDIA_FOR_PLATFORM_PMC		0
#endif
