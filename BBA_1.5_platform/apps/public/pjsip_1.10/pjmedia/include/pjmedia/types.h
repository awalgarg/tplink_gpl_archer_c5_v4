...
typedef enum pjmedia_type
{
	...
	/* 
	 * brief	T38 image application
	 */
	 PJMEDIA_TYPE_IMAGE = 5
...
typedef enum pjmedia_tp_proto
{
    ...
    /** ycw-pjsip UDPTL for T38 fax relay*/
    PJMEDIA_TP_PROTO_UDPTL,
...
#if 0 /*ycw-pjsip: I move this define to stream.h*/
/*
...
typedef enum pjmedia_format_id
{
 	...
 	* brief	T38. ycw-pjsip
 	*/
	 PJMEDIA_FORMAT_T38		 = PJMEDIA_FORMAT_PACK('T', '.', '3', '8')
