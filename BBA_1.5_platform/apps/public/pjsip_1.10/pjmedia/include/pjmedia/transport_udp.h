...
pj_status_t pjmedia_transport_udp_set_mediaPort(pjmedia_transport* tp, pj_uint16_t port);
#	endif

/* 
 * brief	ycw-pjsip. get remote info of the pjmedia transport.
 */
void pjmedia_transport_udp_remote_info(const pjmedia_transport *tp,
							char* remoteIp, pj_uint16_t *rtpPort, pj_uint16_t *rtcpPort);

/*brief ycw-pjsip-note.get local info of the pjmedia transport*/
