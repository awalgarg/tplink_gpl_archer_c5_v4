...
#   define PJMEDIA_HAS_L16_CODEC    0/*1*/
#endif
...
#   define PJMEDIA_HAS_GSM_CODEC    0 /*1*//*ycw-pjsip:we don't support GSM*/
#endif
...
#   define PJMEDIA_HAS_SPEEX_CODEC    0 /*1*//*ycw-pjsip:we don't support SPEEX*/
#endif
...
#   define PJMEDIA_HAS_ILBC_CODEC    0 /*1*//*ycw-pjsip:we don't support iLBC*/
#endif
...
/* 
 * brief	specified T38 fax codec.
 *	ycw-pjsip
 */
#ifndef PJMEDIA_HAS_T38_CODEC
#	 define PJMEDIA_HAS_T38_CODEC		1
#endif
...
#   define PJMEDIA_HAS_INTEL_IPP		0/*ycw-pjsip*/
#endif
...
/*ycw-pjsip*/
/*G721 is the old definition of G726-32. Some Device still use this definition.
So, we must think abount this.*/
#ifndef PJMEDIA_HAS_G721_CODEC
#	define PJMEDIA_HAS_G721_CODEC 1
#endif
/*We need not Intel IPP, because we just need some information about G726, such as
codec name, clock rate, channel count, and so on.*/
#ifndef PJMEDIA_HAS_G726_CODEC
#	define PJMEDIA_HAS_G726_CODEC 1
#endif
