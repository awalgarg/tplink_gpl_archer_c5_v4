...
typedef struct pjsip_inv_callback
{
    ...
    void (*on_rx_offer)(pjsip_inv_session *inv,
	  ...
	  #else
	 pj_status_t (*on_rx_offer)(pjsip_inv_session *inv,
			const pjmedia_sdp_session *offer);
	  #endif
...
/*ycw-pjsip:hold status*/
typedef enum _PJSIP_HOLD_STATUS
{
	PJSIP_HOLD_NONE,
	PJSIP_HOLD_SENT, /*generic voice*/
	PJSIP_HOLD_T38,
	PJSIP_HOLD_PASSTHROUGH /*fax passthrought*/
}PJSIP_HOLD_STATUS;
...
struct pjsip_inv_session
{
    ...
    struct pjsip_timer	*timer;			    /**< Session Timers.    */
 	 PJSIP_HOLD_STATUS		holdStat; /*ycw-pjsip:Identify Hold status*/
	 
	 pj_int32_t xferCallId;/* Id of the call to target*//*ycw-pjsip*/
	 pj_int32_t origXferCallId;
