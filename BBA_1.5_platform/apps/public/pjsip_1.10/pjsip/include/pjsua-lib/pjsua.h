...
#   define PJSUA_ACC_MAX_PROXIES    1/*8*//*ycw-pjsip*/
	...
	/* dingcheng modified 2015-7-8: extend a usbvm endpt for DND */
	#if defined(NUM_FXS_CHANNELS) || defined(NUM_DECT_CHANNELS) || defined(NUM_VOICEAPP_CHANNELS)
	#define PJSUA_USBVM_MAX_RECORDID (NUM_FXS_CHANNELS + NUM_DECT_CHANNELS + NUM_VOICEAPP_CHANNELS + 1)
	#else
...
#define pj_call_voiceapp	0x0004
#define pj_call_voiceapp_anonymous 0x0005
...
/* dingcheng modified 2015-7-8: extend a usbvm endpt for DND */
#if defined(NUM_FXS_CHANNELS) || defined(NUM_DECT_CHANNELS) || defined(NUM_VOICEAPP_CHANNELS)
#define PJSUA_MAX_CMENDPT (NUM_FXS_CHANNELS + NUM_DECT_CHANNELS + NUM_VOICEAPP_CHANNELS + 1)
#else
#define PJSUA_MAX_CMENDPT 2
#endif /* NUM_FXS_CHANNELS || NUM_DECT_CHANNELS || NUM_VOICEAPP_CHANNELS */
