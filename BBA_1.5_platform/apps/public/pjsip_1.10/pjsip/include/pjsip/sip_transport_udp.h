...
/**
 * Use setsockopt to bind the socket of the specific transport to the pjSIP bound network interface
 *
 * @param transport	The UDP transport.
 * @param ifname	pjSIP bound network interface
 * @return		PJ_SUCCESS if bind successfully, or
 *			the appropriate error code.
 * @author	ycw-20120613, yuchuwei@tp-link.net
 */
