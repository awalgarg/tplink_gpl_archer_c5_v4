...
#ifdef INCLUDE_TFC_ES
    PJSIP_H_P_ASSERTED_IDENTITY, /*By YuChuwei, For Telefonica*/
    PJSIP_H_P_PREFERED_IDENTITY, /*By YuChuwei, For Telefonica*/
#endif
...
/******************Add P-Asserted-Identity, For Telefonica******************/
/* 
 * brief	p_asserted_identity header
 */
typedef struct pjsip_p_asserted_identity_hdr
{
	PJSIP_DECL_HDR_MEMBER(struct pjsip_p_asserted_identity_hdr);
	pjsip_uri	*uri;	/**<URI in P-Asserted-Identity header. */
	pjsip_param params;
}pjsip_p_asserted_identity_hdr;

/**
 * Create a P-Asserted-Identity header.
 *
 * @param pool	The pool.
 * @return	New instance of P-Asserted-Identity header.
 */
...
/**
 * Convert the header to a p_asserted_identity header.
 *
 * @param hdr	    The generic P-Asserted-Identity header.
 * @return	    "P-Asserted-Identity " header.
 */
pjsip_p_asserted_identity_hdr* pjsip_p_asserted_identity_hdr_set( pjsip_p_asserted_identity_hdr *hdr );


/******************Add P-Prefered-Identity, For Telefonica******************/
/* 
 * brief	p_asserted_identity header
 */
typedef pjsip_p_asserted_identity_hdr pjsip_p_prefered_identity_hdr;

/**
 * Create a P-Prefered-Identity header.
 *
 * @param pool	The pool.
 * @return	New instance of P-Prefered-Identity header.
 */
 ...
 * Convert the header to a p_asserted_identity header.
 *
 * @param hdr	    The generic P-Prefered-Identity header.
 * @return	    "P-Prefered-Identity " header.
 */
