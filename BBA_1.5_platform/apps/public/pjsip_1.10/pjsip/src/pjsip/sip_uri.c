...
void pjsip_sip_uri_set_secure( pjsip_sip_uri *url, 
				       pj_bool_t secure )
{
...
void pjsip_name_addr_init(pjsip_name_addr *name)
{
...
void pjsip_name_addr_assign(pj_pool_t *pool, pjsip_name_addr *dst,
