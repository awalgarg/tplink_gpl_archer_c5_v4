...
static void subscribe_buddy_presence(pjsua_buddy_id buddy_id)
{
	...
	PJ_TODO(CHECK_ACC_ID);
	//TODO: acc_id may be -1, so, you must check it's value if Enable buddy presence
    acc = &pjsua_var.acc[acc_id];
...
/* 
 * brief	I split mwi to a individual module.yuchuwei@20120412
 */
#	if 0
