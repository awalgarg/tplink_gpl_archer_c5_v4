...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-static --enable-nonfree --enable-gpl --enable-pthreads --disable-shared --disable-encoders --disable-decoders --disable-debug --enable-cross-compile --cross-prefix=mips-linux-uclibc- --arch=mips --target-os=linux --disable-ffserver --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-avdevice
prefix=/usr/local
...
SRC_PATH=/work/Trendchip_89741/tpbsp/apps/public/ffmpeg-0.6
SRC_PATH_BARE=/work/Trendchip_89741/tpbsp/apps/public/ffmpeg-0.6
BUILD_ROOT=/work/Trendchip_89741/tpbsp/apps/public/ffmpeg-0.6
ARCH=mips
CC=$(TOOLPREFIX)gcc
AS=$(TOOLPREFIX)gcc
LD=$(TOOLPREFIX)gcc
DEPCC=$(TOOLPREFIX)gcc
YASM=yasm
YASMDEP=yasm
AR=$(TOOLPREFIX)ar
...
CFLAGS=   -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -O3 -fno-math-errno 
ASFLAGS=   -fPIC
CC_O=-o $@
LDFLAGS=  -L/usr/mediaServer/referenceCode/build/../apps/ushare/mylib -L/usr/mediaServer/referenceCode/build/gcc-3.4.4-2.16.1/build_mips/lib -lgcc_s
FFSERVERLDFLAGS=-Wl,-E
SHFLAGS=-shared -soname $$(@F)
YASMFLAGS=
BUILDSUF=
