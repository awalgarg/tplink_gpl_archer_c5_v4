...
/* copy from XvMC.h(sys/X11/extension) by HouXB, 07Sep10 */
...
/* copy from X.h(XvMC.h->Xv.h->X.h) by HouXB, 07Sep10 */													   
typedef unsigned long XID;

/* copyrom XvMC.h by HouXB, 07Sep10 */
typedef struct {
  XID surface_id;
  XID context_id;
  int surface_type_id;
...
/* coyp from XvMC.h by HouXB, 07Sep10 */
typedef struct {
   unsigned short x;
   unsigned short y;
