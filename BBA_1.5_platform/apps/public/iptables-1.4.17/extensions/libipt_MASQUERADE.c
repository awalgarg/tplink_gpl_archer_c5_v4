...
enum {
	O_TO_PORTS = 0,
	O_RANDOM,
	O_MODE, /* tplink added for nat mode, 20130328 */
};
...
static const struct xt_option_entry MASQUERADE_opts[] = {
	...
	{.name = "mode", .id = O_MODE, .type = XTTYPE_STRING}, /* tplink added for nat mode, 20130328 */
	XTOPT_TABLEEND,
};
...
static void MASQUERADE_parse(struct xt_option_call *cb)
{
	...
	/* Borrow this field as mode value. The default is symmetric, tplink added 20130328 */
	mr->range[0].min_ip = 0;
	...
	/* tplink added for nat mode, 20130328 */
	case O_MODE:
