...
/* Add by chz, 2013-01-24 */
#undef VERSION
#define VERSION "0.8.5"
#define KERNELVERSION "2.6.36"
#define PPPD_VERSION "2.4.5"
/* end add */

extern char** environ;

/* Modify by chz to static to avoid conflict. 2013-01-24 */
//char pppd_version[] = PPPD_VERSION;
static char pppd_version[] = PPPD_VERSION;
/* end modify */
...
/* Modify function name by chz from plugin_init() to pppopptp_init(). 2013-01-24 */
void pppopptp_init(void)
{
