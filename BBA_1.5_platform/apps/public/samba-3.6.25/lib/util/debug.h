...
*/
#if 0 /*1: debug; 0: no debug. Add by zengdongbiao, Jul28. */
...
#if 0 /* modified by gengxianhu for remove debug infomation */

#ifdef __location__
#undef __location__
#endif

#define __DEBUG_LINE1__(s)		#s
#define __DEBUG_LINE2__(s)		__DEBUG_LINE1__(s)
#define __DEBUG_LINE3__		__DEBUG_LINE2__(__LINE__)
#define __location__ __FILE__ ":" __DEBUG_LINE3__
