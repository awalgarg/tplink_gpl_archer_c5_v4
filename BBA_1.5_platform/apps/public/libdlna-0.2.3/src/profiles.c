...
/*all available media profile, Added by LI CHENGLONG , 2011-Dec-08.*/
void
...
dlna_guess_media_profile (dlna_t *dlna, const char *filename)
{
  ...
  if (!dlna->inited)
	...
	/*比如对于mp3格式的文件时如何解析的?当DLNA media server增加一种媒体类型时需要添加相应的库的支持,
  ...
  /*如果执行到这里则说明ffmpeg正确的解析了改类型的媒体文件,下面需要dlna这一层来提取合适的数据返回,
    *Added by LI CHENGLONG , 2011-Dec-07.*/
  p = dlna->first_profile;
  while (p)
  {
    dlna_profile_t *prof;
 	...
 	/*应该去掉, Added by LI CHENGLONG , 2011-Dec-07.*/
	/*先找到后缀名对应的profile, Added by LI CHENGLONG , 2011-Dec-07.*/
    ...
    /* Ended by LI CHENGLONG , 2011-Dec-07.*/
	
	/*直到返回正确的信息或到链表尾, Added by LI CHENGLONG , 2011-Dec-07.*/
...
/* Modify by chz for XBOX360, 2013-02-22 */
//#define UPNP_OBJECT_ITEM_VIDEO            "object.item.videoItem.movie"
#define UPNP_OBJECT_ITEM_VIDEO            "object.item.videoItem"
/* end modify */
