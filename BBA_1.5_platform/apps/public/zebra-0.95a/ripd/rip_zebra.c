...
#if defined(TP_LIST_SUPPORT) && defined(TP_CMD_SUPPORT)
...
#endif /* LIST_SUPPORT and CMD_SUPPORT */
...
#if defined(TP_CMD_SUPPORT) && defined(TP_LIST_SUPPORT)
