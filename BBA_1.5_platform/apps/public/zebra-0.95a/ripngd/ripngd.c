...
/*
#ifdef TP_CMM_MSG
  install_element (CONFIG_NODE, &vtysh_ripng_cmd);
#endif
*/
  install_default (RIPNG_NODE);
/*
#ifdef TP_CMM_MSG
  install_element (RIPNG_NODE, &vtysh_config_cmd);
#endif
*/
#ifdef TP_CMD_SUPPORT
