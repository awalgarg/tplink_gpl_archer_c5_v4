...
/* br0 HW address, Zhang Wenkai, 2017/5/4. */
...
void in6_set_br_addr(unsigned char *pMac)
{
	if (pMac != NULL)
		memcpy(br_hw_addr, pMac, ETH_ALEN);
}
EXPORT_SYMBOL(in6_set_br_addr);
...
static int addrconf_ifid_eui48(u8 *eui, struct net_device *dev)
{
	if (dev->addr_len != ETH_ALEN)
		return -1;
	/* Changed by Zhang Wenkai, 2017/5/4.
