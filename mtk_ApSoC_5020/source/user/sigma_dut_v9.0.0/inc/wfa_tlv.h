...
/*WFDS*/
   ...
   WFA_STA_EXEC_ACTION_TLV,	/* 85 */
   WFA_STA_SET_EAPAKAPRIME_TLV,	/* 86 */

   WFA_STA_COMMANDS_END                  /* 87 */
};
...
enum resp_tags
{
    ...
    WFA_STA_EXEC_ACTION_RESP_TLV,		/* 85 */
    WFA_STA_SET_EAPAKAPRIME_RESP_TLV,           /* 86 */

    WFA_STA_RESPONSE_END                        /* 87 */
};
