 ...
 *
 *
 * $Id: //WIFI_SOC/MP/SDK_5_0_0_0/RT288x_SDK/source/user/mtd-utils/nftl_format.c#1 $
 *
...
int main(int argc, char **argv)
{
	...
	printf("$Id: //WIFI_SOC/MP/SDK_5_0_0_0/RT288x_SDK/source/user/mtd-utils/nftl_format.c#1 $\n");
