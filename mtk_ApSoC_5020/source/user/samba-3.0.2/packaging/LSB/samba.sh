#!/bin/sh
#
# "$Id: //WIFI_SOC/MP/SDK_5_0_0_0/RT288x_SDK/source/user/samba-3.0.2/packaging/LSB/samba.sh#1 $"
#
...
#
# End of "$Id: //WIFI_SOC/MP/SDK_5_0_0_0/RT288x_SDK/source/user/samba-3.0.2/packaging/LSB/samba.sh#1 $".
#
