...
if [ "$CONFIG_ARCH_MT7623" == "y" -o "$CONFIG_RALINK_MT7621" == "y" ]; then
	echo "socket options = TCP_NODELAY SO_RCVBUF=960000 SO_SNDBUF=960000" >> $SAMBA_FILE
else
	echo "socket options = TCP_NODELAY SO_RCVBUF=480000 SO_SNDBUF=40000" >> $SAMBA_FILE
fi
