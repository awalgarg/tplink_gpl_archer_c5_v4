// $Id: //WIFI_SOC/MP/SDK_5_0_0_0/RT288x_SDK/source/user/dhcpforwarder/src/wrappers.h#1 $    --*- c++ -*--
...
/*kurtis: make sure error handler work normally*/
#define NEED_PRINTF
