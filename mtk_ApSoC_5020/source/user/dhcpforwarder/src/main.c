// $Id: //WIFI_SOC/MP/SDK_5_0_0_0/RT288x_SDK/source/user/dhcpforwarder/src/main.c#1 $    --*- c++ -*--
...
#if 0
   printf("fd->iface->if_ip=0x%x\n\r", fd->iface->if_ip);
   printf("fd->iface->if_real_ip=0x%x\n\r", fd->iface->if_real_ip);

   printf("iface_orig->if_ip=0x%x\n\r", iface_orig->if_ip);
   printf("iface_orig->if_real_ip=0x%x\n\r", iface_orig->if_real_ip);
#endif
