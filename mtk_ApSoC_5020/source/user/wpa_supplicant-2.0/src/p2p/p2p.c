...
int p2p_go_params(struct p2p_data *p2p, struct p2p_go_neg_results *params)
{
	...
	params->passphrase[0] = '1';
	params->passphrase[1] = '1';
        params->passphrase[2] = '1';
        params->passphrase[3] = '1';
        params->passphrase[4] = '1';
        params->passphrase[5] = '1';
        params->passphrase[6] = '1';
        params->passphrase[7] = '1';	
	return 0;
}
