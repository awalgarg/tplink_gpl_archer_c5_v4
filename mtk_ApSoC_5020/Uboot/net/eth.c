...
/* Added by chz. 2017-5-5 */
#if defined(TP_MODEL_WR850NV3) || defined(TP_MODEL_EN020_F5V1) /* 4MB flash */
...
/* end add */
			...
			printf("Read MAC Address from Flash\n");
			/* Added by chz. 2017-5-5 */
			raspi_read(rt2880_gmac1_mac, TP_MAC_OFFSET, 6);
			/* end add */
#endif
