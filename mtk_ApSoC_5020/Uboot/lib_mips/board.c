...
#if 0
    /* delete by Zhangwenkai, 2017.8.30.
     * it set pin as ePA/eLNA mode or gpio mode based on value of PA/LNA in EEPROM
     * while in our firmware, kernel_tag rather than EEPROM locates at address: CFG_FACTORY_ADDR-CFG_FLASH_BASE.
     */
	{
		char ee35, ee36;
...
#if defined(TP_MODEL_WR850NV2) || defined(TP_MODEL_C5V4)
				run_command("tftp 0x81000000 tp_recovery.bin;erase tplink 0x20000 0x7a0000;cp.b 0x81020000 0x20000 0x7a0000", 0);
#else
